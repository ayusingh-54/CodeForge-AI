...
- [🚀 Quick Start](#quickstart)## 📋 Table of Contents## 📋 Table of Contents
...
- [🔒 Security](#security)- [💻 Installation & Setup](#installation--setup)- [💻 Installation & Setup](#installation--setup)
...
- [🛠️ CLI Commands](#cli-commands)- [🛠️ CLI Commands & Tools](#cli-commands--tools)

---

- [🧠 How ReAct Works](#how-react-works)- [🧠 How It Works - The ReAct Framework](#how-it-works---the-react-framework)

## 📖 About CodeForge AI {#about}

- [🏗️ Architecture](#architecture)- [🏗️ Project Architecture](#project-architecture)
...
- [⚙️ Configuration](#configuration)- [⚙️ Configuration Guide](#configuration-guide)

### The Problem

Modern developers waste hours on:- [🎯 Use Cases](#use-cases)- [🎯 Real-World Use Cases](#real-world-use-cases)

- Writing boilerplate code

- Managing files across projects- [🔒 Security](#security)- [🔒 Security & Safety](#security--safety)

- Searching for code patterns

- Handling version control- [🤝 Contributing](#contributing)- [🤝 Contributing](#contributing)
...
- **LangGraph** — Workflow management### The Problem- **OpenAI GPT Models** for intelligent reasoning and code generation
...
- **Interactive Prompts**: Smart suggestions**Traditional Way:**2. Writing code from scratch
...
1. Open file editor4. Committing changes to git
...
- **Destructive Guards**: Safeguards against deletions3. Write boilerplate code
...
- **LangGraph** - Multi-step workflow management### 🛠️ Comprehensive Tool Suite
...
cd CodeForge-AI- **Git Integration**: Automated version control (add, commit, push, branching)
...
# 3. Install### 🤖 Intelligent Code Generation

pip install -r requirements.txt

- **Natural Language Interface**: Describe tasks in plain English—no syntax knowledge needed### 🎨 Beautiful CLI Experience

# 4. Configure

nano .env- **Context-Aware**: Understands your project structure and file relationships



# 5. Run- **Multi-Step Reasoning**: Automatically breaks complex tasks into manageable steps- **Rich Terminal UI**: Syntax highlighting, progress bars, and formatted output
...
## 💻 Installation & Setup {#installation}### 🛠️ Comprehensive Tool Suite- **Error Recovery**: Intelligent handling of failures with retry strategies



### Step 1: Clone Repository- **File Operations**: Read, write, append, and intelligently patch files- **Session History**: Track all operations performed in your session



```bash- **Code Search**: Regex and plain-text search across your entire project
...
- **Project Analysis**: Analyze code patterns, dependencies, and architecture- **Safe Script Execution**: Scripts are scanned for unsafe operations
...
- **Execution Traces**: See the AI's step-by-step reasoning process## 🚀 Quick Start

You should see `(.venv)` in your terminal prompt.

- **Error Recovery**: Intelligent failure handling with retry strategies

### Step 3: Install Dependencies

- **Session History**: Full tracking of all operationsGet CodeForge AI running in **less than 5 minutes**!

```bash

pip install -r requirements.txt### 🔒 Security & Safety### Prerequisites

```

- **Path Validation**: Blocks unauthorized directory access

**Installs:** openai, langchain, langgraph, rich, python-dotenv, groq, and utilities
...
- ✅ pip (package manager)python -m venv .venv
...
CODEFORGE_MAX_STEPS=20- ✅ OpenAI API key (https://platform.openai.com/api-keys)
...
LOG_LEVEL=INFO### Windows PowerShellpip install -r requirements.txt
...
1. **OpenAI**: https://platform.openai.com/api-keys# 1. Clonenotepad .env

2. **Exa** (optional): https://exa.ai

3. **Groq** (optional): https://groq.comgit clone https://github.com/ayusingh-54/CodeForge-AI.git



### Step 5: Run Applicationcd CodeForge-AI# 5. Add your API keys to .env
...
```# 2. Virtual environment# 6. Run the application



You should see the CodeForge AI CLI interface!python -m venv .venvpython main.py
...
### Example 1: Create Python Script# 3. Install---
...
**What Happens:**notepad .env### Step 1: Clone the Repository
...
4. Writes file to disk# 5. Run```bash

5. Shows summary of changes

python main.pygit clone https://github.com/ayusingh-54/CodeForge-AI.git
...
1. AI reads the existing functiongit clone https://github.com/ayusingh-54/CodeForge-AI.git# Windows

2. Identifies potential failure points

3. Adds try-catch blocks and loggingcd CodeForge-AIpython -m venv .venv
...
about adding weather API support

```pip install -r requirements.txt



**What Happens:**### Step 3: Install Dependencies
...
3. Displays line numbers and context

4. Creates summary report

5. Suggests refactoring opportunities### Step 1: Clone the RepositoryAdd:



**Result:** Complete analysis of library usage! 🔍
...
## 🛠️ CLI Commands {#commands}git clone https://github.com/ayusingh-54/CodeForge-AI.gitOPENAI_API_KEY=sk-your-api-key-here



### Navigation & Helpcd CodeForge-AIEXA_API_KEY=your-exa-key-here  # Optional



| Command | Description |```CODEFORGE_MODEL=gpt-4o-mini
...
| `:state` | Show current context |### Step 2: Create Virtual EnvironmentCODEFORGE_MAX_STEPS=20
...
### Git Commands.\.venv\Scripts\Activate.ps1```| Tool                   | Description                       |
...
|---------|---------|You should see `(.venv)` in your terminal prompt when active.| `read_file` | Read file contents |
...
- `rich` - Terminal UI|---------|-------------|| `run_python_script` | Execute Python scripts safely |
...
- Search for patterns| `:state` | Show current agent context and workspace state || `git_commit` | Commit changes with message |
...
# Windows| `:ls [path]` | List files in directory (defaults to current) |

**Step 4: Iterating** 🔄

- Refine approachnotepad .env
...
- **Recent Changes**: Files you've modified```

- **Dependencies**: What modules are used

- **Session History**: What you've asked### Basic File Operations
...
├── main.py                    # Entry point# For web search features```

├── ayuverse/                  # Main package

│   ├── config.py             # ConfigurationEXA_API_KEY=your-exa-key-here

│   ├── core/

│   │   ├── agent.py          # ReAct orchestration💬 Create a Python script that fetches weather data from an API and saves it to a JSON file

│   │   └── state.py          # State tracking

│   ├── tools/# For faster inference
...
│       └── helpers.py        # Utilities# ========== MODEL CONFIG ==========

├── Frontend/                  # Web UI (optional)

├── Prompts/                   # Prompt templatesCODEFORGE_MODEL=gpt-4o-mini
...
### Core Components```🔎 Enter your goal: Add error handling to the last file I created



**`agent.py`** — Brain 🧠# ========== DEBUG ==========
...
- Maintains contextLOG_LEVEL=INFO
